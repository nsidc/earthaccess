# [#929](https://github.com/earthaccess-dev/earthaccess/issues/929) Move or fork to independent organization
...
Cons:
* Migration effort
* Potential for reduced developer time without institutional backing.
...
- [ ] (not-planned) Migrate `earthaccess-support` team from `nsidc` -> `earthaccess-dev`
- [x] Update all links in repo to new GitHub URL
