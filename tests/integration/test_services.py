...
class TestServices(VCRTestCase):
    ...
    def _get_vcr(self, **kwargs):
        myvcr = super(TestServices, self)._get_vcr(filter_headers=["Authorization"], filter_post_data_parameters=["access_token"], before_record_response=self.scrub_access_token("access_token", "token") )
    ...
    def test_services(self):
        ...
        self.assertEqual(actual_response["MUR-JPL-L4-GLOB-v4.1"]["S2606110201-XYZ_PROV"][0]["umm"]["LongName"], "Harmony GDAL Adapter (HGA)")        
        self.assertEqual(actual_response["MUR-JPL-L4-GLOB-v4.1"]["S2839491596-XYZ_PROV"][0]["umm"]["URL"]["Description"], "https://harmony.earthdata.nasa.gov")
