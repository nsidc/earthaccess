...
PROD = System(CMRBaseURL(CMR_OPS), StatusURL(STATUS_PROD_URL), StatusApiURL(STATUS_API_PROD_URL), EDLHostname("urs.earthdata.nasa.gov"))
UAT = System(CMRBaseURL(CMR_UAT), StatusURL(STATUS_UAT_URL), StatusApiURL(STATUS_API_UAT_URL), EDLHostname("uat.urs.earthdata.nasa.gov"))
